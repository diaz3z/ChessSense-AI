...
def detect_objects(frame, model, classNames, square_size, start_x, start_y):
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            # Check if start_x and start_y are not None
            if start_x is not None and start_y is not None:
                square_position = get_square_position(center_x, center_y, square_size, start_x, start_y)
                cv2.putText(warped, square_position, (center_x, center_y), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
...
def get_square_position(center_x, center_y, square_size, start_x, start_y):
    col = (center_x - start_x) // square_size
    row = (center_y - start_y) // square_size
    square_position = chr(ord('a') + row) + str(col + 1)
...
while True:
    ...
    if board_contour is not None:
        ...
        detected_frame, bounding_boxes = detect_objects(frame, model, classNames, square_size, start_x, start_y)
